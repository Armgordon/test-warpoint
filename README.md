И вот тестовое по JS:
Создать приложение для конвертации криптовалют.
Две страницы:
1. Конвертер. На странице поле ввода, в которое пользователь может вводить "2 btc in usd" и строка с расчетом.
